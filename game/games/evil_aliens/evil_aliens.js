  ...
  EvilAliens = (function() {
    ...
    function EvilAliens(options) {
      ...
      EvilAliens.__super__.constructor.call(this, _.defaults(this.options, {
        ...
        process_game_over: function() {
          _this.showScreen('game_lost');
          return _this.bg_song.stop();
        },
        screens: {
          loading: 'preset',
          pause: 'preset',
    ...
    EvilAliens.prototype.start = function() {
      ...
      $em.listen('alien::hit_planet', this, function(date) {
        this.lives -= 1;
        if (this.lives === 0) return this.state.send_event('lose');
      });
    ...
    EvilAliens.prototype.getAliens = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ent = _ref[_i];
        if (ent instanceof Alien) _results.push(ent);
      }
      return _results;
    };
    ...
    EvilAliens.prototype.getBullets = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ent = _ref[_i];
        if (ent instanceof EarthBullet) _results.push(ent);
      }
      return _results;
    };
    ...
    EvilAliens.prototype.getBulletExplosions = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ent = _ref[_i];
        if (ent instanceof BulletExplosion) _results.push(ent);
      }
      return _results;
    };
