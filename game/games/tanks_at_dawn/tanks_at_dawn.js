  ...
  function Tanks(options) {
    ...
    Tanks.__super__.constructor.call(this, _.defaults(this.options, {
      ...
      screens: {
        ...
        game: {
          elements: function() {
            var ent, img, map_enities, _i, _len, _ref;
            this.defender = new Tanks.Tank(this);
            ...
            this.visibility_cloak = new VisibilityCloak(this, img);
            window.vis = this.visibility_cloak;
            this.visibility_cloak.setCoords({
              x: 0,
              y: 0
            });
            this.drawn_map = new DrawnMap(this, 'a_viz_map');
            this.drawn_map.setCoords({
              x: 0,
              y: 0
            });
            ...
            return [this.visibility_cloak, this.defender].concat(__slice.call(map_enities));
          },
          on_keys: {
            P: function() {
