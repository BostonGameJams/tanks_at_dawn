  ...
  Mantra.Map = (function() {
    ...
    Map.prototype.generatePresenceLookup = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (this.tileIsSolid(datum)) lookup["" + x + "|" + y] = true;
        i++;
      }
      return lookup;
    };
    ...
    Map.tileCollision = function(obj, map_def, presence_map) {
      var approximation, bottom_tile, left_tile, right_tile, t, tolerance, top_tile, _ref, _ref2, _ref3;
      ...
      for (t = tolerance, _ref2 = obj.colw - tolerance; tolerance <= _ref2 ? t <= _ref2 : t >= _ref2; t += approximation) {
        ...
        if (bottom_tile) obj.toucheddown = true;
        if (top_tile) obj.touchedup = true;
      }
      for (t = tolerance, _ref3 = obj.colh - tolerance; tolerance <= _ref3 ? t <= _ref3 : t >= _ref3; t += approximation) {
        ...
        if (left_tile) obj.touchedleft = true;
        if (right_tile) obj.touchedright = true;
      }
      if (obj.touchedup) {
    ...
    Map.getTileInMap = function(presence_map, x, y, tile_width, tile_height, map_width, map_height) {
      ...
      if (presence_map["" + tile_x + "|" + tile_y]) return 'solid';
      return null;
    };
