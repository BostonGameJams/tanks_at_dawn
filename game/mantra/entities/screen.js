  ...
  Mantra.Screen = (function() {
    ...
    Screen.presets = {
      'intro': {
        ...
        onUpdate: function() {
          if (this.click) return this.showScreen('game');
        }
      },
      'loading': {
        panes: function(options) {
      ...
      'pause': {
        ...
        on_keys: {
          P: function() {
            ...
            if (this.game.bg_song) return this.game.bg_song.play();
          }
        }
      }
    };
    ...
    function Screen(game, name, options) {
      ...
      if (this.options.preset && (preset = Mantra.Screen.presets[this.options.preset])) {
        ...
        if (preset.onUpdate) this.onUpdate || (this.onUpdate = preset.onUpdate);
        if (preset.on_keys) this.addKeyMappings(preset.on_keys);
      }
      if (this.options.elements) {
        this.add.apply(this, this.options.elements.call(this.game));
      }
      if (this.options.update) this.onUpdate = this.options.update;
      if (this.options.on_keys) this.addKeyMappings(this.options.on_keys);
    }
    ...
    Screen.prototype.update = function() {
      if (this.onUpdate && !this.paused) this.onUpdate.call(this.game);
    ...
    Screen.prototype.onKey = function(key) {
      if (this.key_map[key]) return this.key_map[key].apply(this);
    };
